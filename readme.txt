...
Requirements
============
The libraries and software below are supplied with the user
installation file (I, as library and executable files) or the 
source code package (S, as source code):
* Qt Libraries (I)
* Graphviz software (I) 
* Qwt library (I,S)
* GSL library (I,S)
...
Installation
============
Follow the instructions in 'Universal Simulator Explained' found in
the Downloads sections of www.ecolmod.org.
