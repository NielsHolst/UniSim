	...
	: Model(name, parent)
{
    ...
    Input (double, startLayer6, 0.);            //m
    Input (double, startLayer2, 0.);            //m
    Input (double, startLayer3, 0.);            //m
    Input (double, startLayer10, 0.);           //m
    Input (double, startLayer11, 0.);           //m
    Input (double, startLayer8, 0.);            //m
    Input (double, startLayer7, 0.);            //m
    Input (double, startLayer5, 0.);            //m
    Input (double, penetrationDepth, 0.01);      //default value, 0.01 m
    Input (double, startLayer1, 0.);             //sm
    Input (double, startLayer4, 0.);             //m
    Input (double, startLayer9, 0.);             //m
