...
void InsecticideFactory::defineProducts() {
    ...
    AddProduct(HazardQuotient, "For risk assessment of substances such as parent or metabolite");
    AddProduct(VolatilizationPlantLeaf, "For volatilization from plant leaf");
}
