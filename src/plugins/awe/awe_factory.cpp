...
Identifier AweFactory::id() const {
    return "awe";
}

QList<Identifier> AweFactory::inventory() {
    return productList().keys();
}

QObject* AweFactory::create(Identifier className, Identifier objectName, QObject *parent) {
