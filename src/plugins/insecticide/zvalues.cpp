	...
	: Model(name, parent)
{
    ...
    Input (double, pb, 1100.);          // kg/m3 or 1.1 g/cm3
    ...
    Input (double, TrefVP, 25.);        //reference temperature of vapour pressure (degC)
    Input (double, Tsa, 30.);           //soil air temperature (deg C)
