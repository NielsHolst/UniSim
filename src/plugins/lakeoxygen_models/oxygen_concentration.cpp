	...
	: Model(name, parent)
{
    ...
    new Variable<double>("DOSatConc", &doSatConc, this, "Calculated oxygen concentration estimated from temperature [mg/l]");
}
...
void OxygenConcentration::update() {
    ...
    double temp = weather->pullValue<double>("tempw");
