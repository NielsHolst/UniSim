...
void TestRandom::testUniform() {
    Model *model = ModelMaker::create("RandomUniform", "test", 0);
...
void TestRandom::testLognormal() {
    Model *model = ModelMaker::create("RandomLognormal", "test", 0);
    model->initialize();
    generateObs(model);
...
void TestRandom::testNormal() {
    Model *model = ModelMaker::create("RandomNormal", "test", 0);
    model->initialize();
    generateObs(model);
...
void TestRandom::testPoisson() {
    Model *model = ModelMaker::create("RandomPoisson", "test", 0);
    model->initialize();
    generateObs(model);
