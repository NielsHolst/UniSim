 ...
 * - _donorAh_ is the ambient absolute humidity outdoors [kg/m<SUP>3</SUP>]
 * - _receiverAh_ is the ambient absolute humidity indoors [kg/m<SUP>3</SUP>]
 *
 * Outputs
 * ------
 * - see VapourFlux
    ...
    : VapourFluxBase(name, parent)
{
    ...
    InputRef(double, donorAh,"outdoors[ah]");
    InputRef(double, receiverAh, "indoors/humidity[ah]");
    InputRef(double, height,"construction/geometry[averageHeight]");
}

void VapourFluxVentilation::update() {
    conductance = height*ventilationSupply/3600;    // m/s = m3/m2 * m3/m3/h / (s/h)
