...
#include "general.h"
#include "publish.h"
#include "ventilation_air.h"
using namespace UniSim;

namespace vg {

PUBLISH(VentilationAir)

/*! \class VentilationAir
...
VentilationAir::VentilationAir(Identifier name, QObject *parent)
	: Model(name, parent)
{
...
void VentilationAir::reset() {
    absolute = relative = 0;
}

void VentilationAir::update() {
